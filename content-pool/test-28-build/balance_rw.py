...
Written by hand, the correct option tends to land in the same place — for Test 28 it
was A 72, C 9, B 0, D 0, which a student would notice within one module.
...
def main():
    ...
    with open("rw_test28_balanced.json", "w") as fh:
        json.dump(out, fh, indent=1, ensure_ascii=False)
    print("wrote rw_test28_balanced.json")
