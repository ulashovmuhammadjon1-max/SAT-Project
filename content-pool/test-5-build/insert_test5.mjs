 ...
 *
 *   DATABASE_URL='postgresql://...' node insert_test5.mjs [--publish]
 *
...
const math = JSON.parse(readFileSync(path.join(HERE, "test5_math.json"), "utf8"));
const rw = JSON.parse(readFileSync(path.join(HERE, "test5_rw.json"), "utf8"));
...
const PLAN = [
  ["RW_M1",    "RW",   rw["test5|RW_M1"]],
  ["RW_M2E",   "RW",   rw["test5|RW_M2_EASY"]],
  ["RW_M2H",   "RW",   rw["test5|RW_M2_HARD"]],
...
console.log(`\nTest 5 (${testId}) — ${total} questions inserted this run`);
