...
Written by hand, the correct option tends to land in the same place. Test 26
came in at A 81, B 0, C 0, D 0: every item was drafted with its key first and
its distractors after it, which puts the key on A every time. A student would
notice that inside one module.
...
def main():
    ...
    with open("rw_test26_balanced.json", "w") as fh:
        json.dump(out, fh, indent=1, ensure_ascii=False)
    print("wrote rw_test26_balanced.json")
