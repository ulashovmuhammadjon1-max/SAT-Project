...
CLAIMS = [
 ...
 ("presidential envoys",
  "EK DEM-2.B.5.c presents the federal districts with presidential envoys and the president-approved gubernatorial lists as reasserting federal power under the Russian president, and EK PAU-2.A.2 allows the degree of centralization to move inside a federal structure. The rejected options devolve authority, adjudicate its boundaries, or exercise a power the constitution had already allocated."),
