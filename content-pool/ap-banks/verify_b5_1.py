...
CLAIMS = [
 ...
 ("Twice, once at the end of each of the two meiotic divisions",
  "EK 5.1.A.2.iv places cytokinesis at the end of telophase I, giving two haploid cells, and EK 5.1.A.3.iv places it again at the end of telophase II, giving four. The cytoplasm is divided once per division, not once per process."),
 ...
 ("Four haploid daughter cells are already present at the end of meiosis I",
  "EK 5.1.A.2.iv states that TWO haploid daughter cells are formed at the end of meiosis I, and EK 5.1.A.3.iv puts the count of four at the end of meiosis II. The other four options restate EK 5.1.A.2.i, EK 5.1.A.3.ii, EK 5.1.A.3.iv and EK 5.1.B.1."),
