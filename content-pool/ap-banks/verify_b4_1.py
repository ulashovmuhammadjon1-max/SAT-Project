...
CLAIMS = [
 ...
 ("travel long distances to target cells of another type",
  "The CED lists testosterone and estrogen among the illustrative examples of EK 4.1.B.2, signals released by one cell type that travel long distances to target cells of another type."),
