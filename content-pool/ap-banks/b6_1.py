...
QUESTIONS = [
 ...
 dict(q="In a double-stranded DNA molecule, adenine on one strand pairs with which base on the other strand?",
   choices=[
     "Thymine, and with uracil where the partner strand is RNA",
     "Guanine, and with cytosine where the partner strand is RNA",
     "Cytosine, and with uracil where the partner strand is RNA",
     "Adenine, since a base pairs with another copy of itself",
     "Uracil, since thymine is not found in any nucleic acid"], ans=0,
   why="EK 6.1.B.1.iii states that purines pair with pyrimidines: adenine with thymine, or uracil in RNA, and guanine with cytosine. Thymine is the partner in DNA, and the same statement supplies uracil as the RNA substitute rather than as a replacement everywhere."),
