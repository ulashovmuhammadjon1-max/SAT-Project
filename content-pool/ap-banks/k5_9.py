...
QUESTIONS = [
 ...
 dict(q="According to the same table of years, the range of the world price index across the period is",
   ...
   choices=[
     ...
     "47 points",
     "69 points"], ans=0,
   why="Subtracting the smallest world price figure from the largest gives the range. The alternatives are the two gaps against the starting year, the range of the programme spending column, and the range of the revenue column."),
 dict(q="Using the same table of years, the range of the government revenue index across the period is",
   ...
   choices=[
     ...
     "47 points",
     "91 points"], ans=0,
   why="Subtracting the smallest revenue figure from the largest gives the range. The alternatives are the two gaps against the starting year, the range of the programme spending column, and the range of the world price column."),
