...
CLAIMS = [
 ...
 ("reflects the common ancestry",
  "EK 2.1.A.1 states that ribosomes are found in cells in all forms of life and reflect the common ancestry in all known life. Universality is read as inheritance from a shared ancestor rather than as repeated independent invention."),
