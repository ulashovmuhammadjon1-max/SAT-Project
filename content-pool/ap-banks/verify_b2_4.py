...
CLAIMS = [
 ...
 ("lose its selective permeability, because that property is stated to result",
  "EK 2.4.A.1 states that selective permeability IS THE RESULT of the plasma membrane having a hydrophobic interior, so removing that interior removes the stated cause. EK 2.4.A.2 and EK 2.4.A.3 make the interior what SORTS substances rather than what excludes all of them, which is why total impermeability is not the prediction."),
