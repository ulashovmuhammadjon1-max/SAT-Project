...
CLAIMS = [
 ...
 ("Mexico's president",
  "EK PAU-3.C.2.c describes Mexico's elected president as commander in chief and leader of the bureaucracy, able to approve domestic legislation and lead foreign policy, and RESTRICTED TO ONE TERM. That restriction is one of only two term-limit figures the framework prints, and it is what separates this office from the otherwise near-identical one at EK PAU-3.C.2.d."),
 ("Nigeria's president",
  "EK PAU-3.C.2.d lists head of state, head of government, chief executive, commander in chief and head of civil service together for Nigeria's elected president, adding the approval of domestic legislation and the conduct of foreign policy. Each rejected office holds only some of those five under EK PAU-3.C.2.a, .b, .e and .f."),
