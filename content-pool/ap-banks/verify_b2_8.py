...
CLAIMS = [
 ...
 ("Molecules and ions alike",
  "EK 2.8.A.1 names both together: metabolic energy is required for active transport of molecules AND IONS across the membrane. Water carried through aquaporins is EK 2.6.A.3's route, which EK 2.6.A.2 states takes no energy input, so it is not what this statement is about."),
