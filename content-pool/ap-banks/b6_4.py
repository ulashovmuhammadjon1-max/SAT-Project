...
QUESTIONS = [
 ...
 dict(q="Using the genetic code chart in the table, what polypeptide is encoded by the mRNA sequence AUGUUUGGACAUUAA?",
   table=_T_CODE,
   choices=[
     "Methionine, phenylalanine, glycine, histidine, and then the chain is released",
     "Methionine, phenylalanine, glycine, histidine and serine",
     "Methionine, phenylalanine, glycine, histidine and lysine",
