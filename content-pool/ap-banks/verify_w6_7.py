...
CLAIMS = [
 ...
 ("The heading Regulation of immigrants",
  "The CED prints the Chinese Exclusion Act under Regulation of immigrants in topic 6.7, beside KC-5.4.III.C, the statement about states attempting to regulate the increased flow of people across their borders. Migrant ethnic enclaves is the other heading on that page, Return of migrants and Migrants belong to topic 6.6 and resource export economies to topic 6.4."),
