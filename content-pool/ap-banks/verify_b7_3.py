...
CLAIMS = [
 ...
 ("narrowed while the range of forms across the species as a whole has been widened",
  "EK 7.3.A.1's verb is affect, which fixes no direction, and this module's own data show both at once: one table records a trait's range narrowing across twenty generations within a line and another records three varieties each exceeding the wild form on a different trait. The two are variation measured at different levels and are not in conflict."),
 ("161 milligrams",
 ...
 ("humans affect variation in other species, and the people described are acting on their own",
  "EK 7.3.A.1 states that through artificial selection humans affect variation in OTHER species, which is the clause the example falls outside. The framework attaches no requirement about laboratories, about how variable the trait is, or about the size or stability of the population."),
