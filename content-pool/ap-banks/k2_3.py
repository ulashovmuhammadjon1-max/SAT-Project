...
QUESTIONS = [
 ...
 dict(q="Which description of Mexico's president is consistent with the framework?",
   choices=[
     "an elected leader who is both head of state and head of government, serves as commander in chief and leader of the bureaucracy, and is restricted to one term",
     "an elected leader who nominates a premier to serve as head of government",
     "a ceremonial head of state who formally appoints the head of government",
     "an unelected leader who appoints the head of the judiciary",
     "an elected head of state who shares the executive with a prime minister overseeing the civil service"], ans=0,
   why="EK PAU-3.C.2.c describes Mexico's elected president as both head of state and head of government, commander in chief and leader of the bureaucracy, able to approve domestic legislation and lead foreign policy, and restricted to one term. The one-term restriction is one of only two term-limit figures the framework prints."),
 dict(q="Which description of Nigeria's president is consistent with the framework?",
   choices=[
     "an elected leader who is both head of state and head of government, serving as chief executive, commander in chief, and head of the civil service",
     "an elected head of state who appoints a prime minister to oversee the civil service",
     "a ceremonial head of state with no role in policy",
     "an unelected leader who sets the political agenda and appoints top ministers",
     "a head of government selected by the largest party in the elected chamber"], ans=0,
   why="EK PAU-3.C.2.d describes Nigeria's elected president as both head of state and head of government, serving as chief executive, commander in chief and head of civil service, and able to approve domestic legislation and conduct foreign policy."),
