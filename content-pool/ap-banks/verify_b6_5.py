...
CLAIMS = [
 ...
 ("expressed even without the signal",
  "EK 6.5.A.1 states that regulatory sequences interact with regulatory proteins to control transcription and that some genes are inducible. The control over an inducible gene is that interaction, so losing the protein loses the switch rather than the transcription; EK 6.5.A.3 makes expression a property of the individual cell."),
