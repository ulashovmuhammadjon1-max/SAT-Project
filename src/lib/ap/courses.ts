...
/** AP World History: Modern, 9 units and 71 topics. Generated by
 *  content-pool/ap-banks/gen_course_units.py from WORLD_HISTORY_topics.json. */
const WORLD_HISTORY_UNITS: ApUnit[] = [
  {
    number: 1,
    title: "The Global Tapestry",
    topics: [
      { code: "1.1", title: "Developments in East Asia from c. 1200 to c. 1450" },
      { code: "1.2", title: "Developments in Dar al-Islam from c. 1200 to c. 1450" },
      { code: "1.3", title: "Developments in South and Southeast Asia from c. 1200 to c. 1450" },
      { code: "1.4", title: "State Building in the Americas" },
      { code: "1.5", title: "State Building in Africa" },
      { code: "1.6", title: "Developments in Europe from c. 1200 to c. 1450" },
      { code: "1.7", title: "Comparison in the Period from c. 1200 to c. 1450" },
    ],
  },
  {
    number: 2,
    ...
    topics: [
      { code: "2.1", title: "The Silk Roads" },
      { code: "2.2", title: "The Mongol Empire and the Making of the Modern World" },
      { code: "2.3", title: "Exchange in the Indian Ocean" },
      { code: "2.4", title: "Trans-Saharan Trade Routes" },
      { code: "2.5", title: "Cultural Consequences of Connectivity" },
      { code: "2.6", title: "Environmental Consequences of Connectivity" },
      { code: "2.7", title: "Comparison of Economic Exchange" },
    ],
  },
  {
    number: 3,
    ...
    topics: [
      { code: "3.1", title: "Empires Expand" },
      { code: "3.2", title: "Empires: Administration" },
      { code: "3.3", title: "Empires: Belief Systems" },
      { code: "3.4", title: "Comparison in Land-Based Empires" },
    ],
  },
  {
    number: 4,
    ...
    topics: [
      { code: "4.1", title: "Technological Innovations from 1450 to 1750" },
      { code: "4.2", title: "Exploration: Causes and Events from 1450 to 1750" },
      { code: "4.3", title: "Columbian Exchange" },
      { code: "4.4", title: "Maritime Empires Established" },
      { code: "4.5", title: "Maritime Empires Maintained and Developed" },
      { code: "4.6", title: "Internal and External Challenges to State Power from 1450 to 1750" },
      { code: "4.7", title: "Changing Social Hierarchies from 1450 to 1750" },
      { code: "4.8", title: "Continuity and Change from 1450 to 1750" },
    ],
  },
  {
    number: 5,
    title: "Revolutions",
    topics: [
      { code: "5.1", title: "The Enlightenment" },
      { code: "5.2", title: "Nationalism and Revolutions in the Period from 1750 to 1900" },
      { code: "5.3", title: "Industrial Revolution Begins" },
      { code: "5.4", title: "Industrialization Spreads in the Period from 1750 to 1900" },
      { code: "5.5", title: "Technology of the Industrial Age" },
      { code: "5.6", title: "Industrialization: Government’s Role from 1750 to 1900" },
      { code: "5.7", title: "Economic Developments and Innovations in the Industrial Age" },
      { code: "5.8", title: "Reactions to the Industrial Economy from 1750 to 1900" },
      { code: "5.9", title: "Society and the Industrial Age" },
      { code: "5.10", title: "Continuity and Change in the Industrial Age" },
    ],
  },
  {
    number: 6,
    ...
    topics: [
      { code: "6.1", title: "Rationales for Imperialism from 1750 to 1900" },
      { code: "6.2", title: "State Expansion from 1750 to 1900" },
      { code: "6.3", title: "Indigenous Responses to State Expansion from 1750 to 1900" },
      { code: "6.4", title: "Global Economic Development from 1750 to 1900" },
      { code: "6.5", title: "Economic Imperialism from 1750 to 1900" },
      { code: "6.6", title: "Causes of Migration in an Interconnected World" },
      { code: "6.7", title: "Effects of Migration" },
      { code: "6.8", title: "Causation in the Imperial Age" },
    ],
  },
  {
    number: 7,
    ...
    topics: [
      { code: "7.1", title: "Shifting Power After 1900" },
      { code: "7.2", title: "Causes of World War I" },
      { code: "7.3", title: "Conducting World War I" },
      { code: "7.4", title: "Economy in the Interwar Period" },
      { code: "7.5", title: "Unresolved Tensions After World War I" },
      { code: "7.6", title: "Causes of World War II" },
      { code: "7.7", title: "Conducting World War II" },
      { code: "7.8", title: "Mass Atrocities After 1900" },
      { code: "7.9", title: "Causation in Global Conflict" },
    ],
  },
  {
    number: 8,
    ...
    topics: [
      { code: "8.1", title: "Setting the Stage for the Cold War and Decolonization" },
      { code: "8.2", title: "The Cold War" },
      { code: "8.3", title: "Effects of the Cold War" },
      { code: "8.4", title: "Spread of Communism After 1900" },
      { code: "8.5", title: "Decolonization After 1900" },
      { code: "8.6", title: "Newly Independent States" },
      { code: "8.7", title: "Global Resistance to Established Power Structures After 1900" },
      { code: "8.8", title: "End of the Cold War" },
      { code: "8.9", title: "Causation in the Age of the Cold War and Decolonization" },
    ],
  },
  {
    number: 9,
    title: "Globalization",
    topics: [
      { code: "9.1", title: "Advances in Technology and Exchange After 1900" },
      { code: "9.2", title: "Technological Advances and Limitations After 1900: Disease" },
      { code: "9.3", title: "Technological Advances: Debates About the Environment After 1900" },
      { code: "9.4", title: "Economics in the Global Age" },
      { code: "9.5", title: "Calls for Reform and Responses After 1900" },
      { code: "9.6", title: "Globalized Culture After 1900" },
      { code: "9.7", title: "Resistance to Globalization After 1900" },
      { code: "9.8", title: "Institutions Developing in a Globalized World" },
      { code: "9.9", title: "Continuity and Change in a Globalized World" },
    ],
  },
];
...
export const AP_COURSES: ApCourse[] = [
  ...
  },
  {
    ...
    short: "World History",
    blurb: "Global processes from about 1200 CE to the present, across nine units.",
