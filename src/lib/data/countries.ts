// Generated from the ISO 3166-1 alpha-2 list with names from Intl.DisplayNames.
// Edit the generator rather than this file if the list ever needs to change.
...
/** Shown at the top of the picker — the platform's core audience. */
export const PRIORITY_COUNTRIES = ["UZ", "KZ", "KG", "TJ", "TM", "US", "IN", "PK", "NG", "GB", "CA"];
...
export function countryName(code: string | null | undefined): string {
  return countryByCode(code)?.name ?? "Unknown";
}
